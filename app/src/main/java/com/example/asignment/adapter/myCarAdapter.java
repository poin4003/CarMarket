...
import com.example.asignment.MyCarsDetail;
import com.example.asignment.R;
import com.example.asignment.models.carModels;

import java.util.List;

public class myCarAdapter extends RecyclerView.Adapter<myCarAdapter.CarViewHolder> {
    private List<carModels> cars;

    public myCarAdapter(List<carModels> cars) {
        this.cars = cars;
    }
    ...
    public void onBindViewHolder(@NonNull CarViewHolder holder, int position) {
        ...
        holder.btnViewDetail.setOnClickListener(v -> {
            Intent intent = new Intent(holder.itemView.getContext(), MyCarsDetail.class);
